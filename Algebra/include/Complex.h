...
class Complex : public virtual Module<Complex>::Ring {
public:
    virtual ~Complex(){}
...
class Real : public Complex , public virtual Module<Real>::Ring
{
public:
    virtual ~Real(){}
    typedef Group<Complex>::Ptr ComplexPtr;
    typedef Group<Real>::Ptr RealPtr;
